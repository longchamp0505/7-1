...
<div class="form-container">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group">
            ...
            @enderror
            <input type="text" id="registration_login_id_input" name="email" placeholder="メールアドレス">
        </div>
        ...
        <div class="form-group">
            ...
            @enderror
            <input type="password" id="registration_password_input" name="password" placeholder="パスワード">
        </div>
        ...
        <div class="form-group">
            ...
            @enderror
            <input type="password" id="registration_re_password_input" name="password_confirmation" placeholder="パスワード確認">
        </div>
        ...
        <div class="form-group">
            ...
            @enderror
            <select id="registration_country_select" name="country_id">
